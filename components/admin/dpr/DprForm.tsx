      ...
      <Form form={form} layout="vertical" onFinish={handleFinish}>
        ...
        >
          <Select
            ...
            options={[
              { label: 'BUFFER CALL', value: 'buffer_call' },
              { label: 'PPC', value: 'ppc' },
        ...
        <Form.Item
          label="Call Query"
          name="callQuery"
          rules={[{ required: true, message: 'Please select call query' }]}
        >
          <Select
            ...
            options={[
              ...
              { label: 'SHOPPERS CALLS', value: 'shoppers_calls' },
              { label: 'BAGS', value: 'bags' },
              { label: 'SALE', value: 'sale' },
              { label: 'INFORMATION', value: 'information' },
              { label: 'NON AIRLINE', value: 'non_airline' },
              { label: 'NEW BOOKING', value: 'new_booking' },
              { label: 'FOLLOW UP', value: 'follow_up' },
              { label: 'NO VOICE', value: 'no_voice' },
              {
