...
import { Card, Input, Table, Typography, Row, Col, Button, Space, Skeleton, Modal } from 'antd';
import { SearchOutlined, PlusOutlined } from '@ant-design/icons';

import { manageUserColumns } from './manageUserColumns';
import ManageUserRegisterModal from './ManageUserRegisterModal';
...
export default function ManageUsersTable({ users = [], loading = false, onDelete }: Props) {
  ...
  return (
    <>
      ...
      <ManageUserRegisterModal open={open} onClose={() => setOpen(false)} />
    </>
  );
}
